                      ...
                      return(
                          <div className={styles.productBox}>
                            ...
                            <div className={styles.checkingRow}>
                                ...
                                <input type="checkbox" className={styles.pickBox} defaultChecked={checked} onChange={() => setChecked(!checked)}/>
                             ...
                             {/*   <div className={styles.pickedProduct}>
                                       ...
                                       <div className={styles.quantityNum}>
                                        ...
                                        <input type="number" min="1" placeholder="1" className={styles.numBox}></input>
                ...
                <div className={styles.boxAndBttn}>
                    <div className={styles.choicesBox}>
                        <div className={styles.choicesBoxTitle}>Vaš odabir</div>
                          ...
                          {data.allContentfulMakeYourOwnProduct.nodes.map(el=>{
                            return(
                              checked ?
                              <div className={styles.pickedProduct}>
                                       <Img className={styles.pickedProductImage} fixed={el.image.fixed}/>
                                       <div className={styles.quantityNum}>
                                
                                        <input type="number" min="1" placeholder="1" className={styles.numBox}></input>
                                         
                                      </div>
                                      <div className={styles.pickedProductPrice}>{el.price}</div>
                                </div>
                                :null
                            )
                          })}
