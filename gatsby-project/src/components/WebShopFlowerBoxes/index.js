...
import { productsFlowerboxes } from '../../constants/const'
import Combobox from '../ComboBox'
import {Link} from 'gatsby'
import styles from './style.module.css'


const WebShopFlowerBoxes = () => (
        <div>
            <p className={styles.webTitle}>Web shop - Cvjetne kutije</p>
            ...
            <div className={styles.categories}>
                {productsFlowerboxes.map(({productName, productPrice, productImage, to}) => (
...
export default WebShopFlowerBoxes
